...
exports.AnonOn = () => {
    return `Minimal Stop in dulu lah bego😂`
}
exports.AnonFind = (prefix) => {
    return `_Pasangan lu nih😂_\n${prefix}skip -- _cari pasangan baru_\n${prefix}stop -- _hentikan dialog ini_`
}
exports.AnonSearch = () => {
    return `Bentar lagi cariin lu pacar,lu kan jomblo😂`
}
exports.NoAnon = () => {
    return `Coba Ketik .start nah kan udah mulai mampus ga bisa di berhentiin😂`
}
...
exports.KickAh = (gc) => {
    ...
    exports.GjdKick = () => {
    return `Hoki aja kau,kalo tadi kau kirim link aneh aneh udah ku kick anj😂`
    }
/////////

/////////
exports.private = () =>{
	return`Kan Udah ada list fitur grup,kenapa masih main di private? gaje`
	}
exports.wait = () => {
    return `Sabar njink`
}
...
exports.err = () => {
    return `Fitur rusak males fix😂`
}
exports.erorLink = () => {
    return `Lu ngasih link apa anj😂`
}
exports.media = () => {
    return `Pilih nih`
}
...
exports.wrongFormat = (prefix) => {
    return `Gatau format baca dulu kalo punya mata,kalo ga serah mau dimakan juga *${prefix}allmenu*.`
}
...
exports.ownerOnly = () => {
    return `Cmd Owner jangan ngadi ngadi kau anj😂`
}

exports.doneOwner = () => {
    return `Okeii udah selesai owner ganteng`
}

exports.groupOnly = () => {
    return `Buat Di Grup Anj😂`
}

exports.adminOnly = () => {
    return `Kau bukan atmin anj kasihan😂`
}

exports.nhFalse = () => {
    return `Kode macam apa ini?`
}

exports.listBlock = (blockNumber) => {
    return `*── 「 HELL OF STUPID PEOPLE 」 ──*
    
Total diblokir: *${blockNumber.length}* user\n`
}

exports.notAdmin = () => {
    return `Dia Bukan atmin,coba kalo punya mata lihat dulu ingfo grup😂`
}

exports.adminAlready = () => {
    return `Udah atmin di atminin,punya mata ga tod?`
}

exports.botNotAdmin = () => {
    return `Kalo Nyuruh gw minimal atminin lah tod`
}
